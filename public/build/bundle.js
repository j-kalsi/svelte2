...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			img = element("img");
    			attr_dev(h1, "class", "svelte-1r2iqvt");
    			add_location(h1, file, 17, 1, 300);
    			attr_dev(label0, "for", "firstName");
    			add_location(label0, file, 18, 1, 327);
    			attr_dev(input0, "type", "text");
    			add_location(input0, file, 19, 4, 373);
    			attr_dev(label1, "for", "lastName");
    			add_location(label1, file, 20, 1, 417);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 21, 1, 458);
    			add_location(button, file, 22, 1, 501);
    			if (!src_url_equal(img.src, img_src_value = "src")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "svelte logo");
    			add_location(img, file, 23, 1, 560);
    			attr_dev(main, "class", "svelte-1r2iqvt");
    			add_location(main, file, 16, 0, 292);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*resetName*/ ctx[3], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let firstName = "";
    	let lastName = "";
    	let src = "download.png";
    	let count = 0;

    	const resetName = () => {
    		$$invalidate(0, firstName = "unknown");
    		$$invalidate(1, lastName = "unknown");
    	};
